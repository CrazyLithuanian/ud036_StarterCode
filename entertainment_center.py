...
matrix = media.Movie('The Matrix', 'In near future people are plugged into virtual reality machine, some of them'
...
ai = media.Movie('A.I. Artificial Intelligence', 'A boy robot wants to become a human',
                 'http://www.impawards.com/2001/posters/ai_artificial_intelligence_ver5.jpg',
                 'https://www.youtube.com/watch?v=_19pRsZRiz4')
# Creating instance of movie "Inception"
inception = media.Movie('Inception', 'Dreams are used to influence subconscious',
...
clockwork_orange = media.Movie('Clockwork Orange',
                               'A deviant teen, gets transformed by psychological conditioning',
                               'http://retromovieposter.com/wp-content/uploads/2015/03/1971-A-Clockwork-Orange-small'
                               '.jpg',
...
living_dead = media.Movie('Night of the Living Dead', 'Dead comes to life to kill and ead the living',
                          'https://s3.amazonaws.com/criterion-production/shop_product_images/771'
...
mile8 = media.Movie('8 Mile', 'Talented rapper finds himself in dead-end job, homeless, working his way out',
